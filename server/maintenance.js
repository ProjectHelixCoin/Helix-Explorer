...
.container .button {
  ...
  <body>
    <div class="logo">
      <a href="https://helix-crypto.com/">
        <img src="https://helix-crypto.com/wp-content/uploads/2018/06/logo@2x.png" title="Helix Crypto"/>
      </a>
      </div>
    <div class="container">
        <img src="https://media.giphy.com/media/vIDsZm5DMZ5Ha/giphy.gif" title="Sad Explorer."/>
      <h1>Maintenance</h1>
      <p>Helix Explorer is not available at this moment.<br/>Please check back later.</p><br/>
  <a href="https://helix-crypto.com/" class="button">Back to Main</a>
      </div>
  </body>
</html>
  `);
